...
function Privacy() {
  return (
    <>
      <PageInfo>PRIVACY POLICY</PageInfo>
      <div className="container my-5 py-2">
        <h4>
          <strong>
            Welcome Pizza Delivery we recognize that privacy is important!!
          </strong>
          <hr />
        </h4>
        <p>
        ...
        <p>
          Pizza Delivery may collect personal information from you including
        ...
        <p>
          Where ever Pizza Delivery collects personal information about you from
          someone else, Pizza Delivery or the franchisee will take reasonable
          steps to advise you.
        </p>
        <br />
        <h4>
        ...
        <p>
          Pizza Delivery may use the personal information that you submit to
        ...
        <p>
          When using the Pizza Delivery internet ordering system additional
          ...
          future. When concluding your order via the Pizza Delivery internet
          ordering system, you will be asked if you would like to become a WOW
          Club member. To not become a member untick the box.
        </p>
        <br />
        <h4>
        ...
        <p>Pizza Delivery does not store any of your credit card details.</p>
        <br />
        <h4>
        ...
        <p>
          Pizza Delivery may share statistics and personal information between
          themselves and with companies that are related to Pizza Delivery
          including our international branches.Personal information that you
          submit to Pizza Delivery may be disclosed to a third party: Such as
        ...
        <ul>
          ...
          <li>
            {" "}
            If Pizza Delivery are required or authorized by law to disclose the
            information.{" "}
          </li>
          <li>
            {" "}
          ...
          <li>
            {" "}
            If Pizza Delivery feel you might like to know about a third party's
            goods and services we may supply that personal information to that
            third party. (We know that many of our guests enjoy receiving these
            excellent offers).{" "}
          </li>
          <li>
            {" "}
        ...
        <p>
          Pizza Delivery will take reasonable steps to ensure that the personal
          ...
          contacting us.Pizza Delivery will take reasonable steps to protect
        ...
        <p>
          Pizza Delivery will not collect, use or disclose sensitive information
        ...
        <p>
          Each time you visit the Pizza Delivery's site our server collects some
          ...
          visit; and your server's IP address. Pizza Delivery may collect this
          ...
          duration of visits, most popular session times. Pizza Delivery may use
          this information to evaluate and improve the Pizza Delivery's
          websites.
        </p>
        <br />
        <h4>
        ...
        <p>
          ...
          your machine when you visit a Pizza Delivery's site. A Cookie helps us
