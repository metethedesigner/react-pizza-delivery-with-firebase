  ...
  return (
    <>
      ...
      <div className="container my-5 py-2">
        <h4>
          <strong>Pizza Delivery: Delivering Happiness</strong>
          <hr />
        </h4>
        ...
        <p>
          With Pizza Delivery it is always “Rishton ka time”. Whether it's a
          treat for your promotion, a kid topping his class or winning the heart
        ...
        <p>
          ...
          pizza. Because just like a pizza, Pizza Delivery understands you.
        </p>
        <br />
        <h4>
        ...
        <p>
          ...
          fabulous pizza is that Pizza Delivery takes only half an hour for its
          pizza delivery service. Don’t believe us? Time it if you please. With
          1250+ stores present all over India, you can have a Pizza Delivery
          pizza even while traveling on a train. Yes, you are reading it right,
          you can enjoy pizza on train too.
        </p>
        <p>
